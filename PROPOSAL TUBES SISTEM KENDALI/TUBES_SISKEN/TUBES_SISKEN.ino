...
#define TIDAK  "Tidak"
 ...
 String ssid = "Rumahku1";
 String pass = "Rumahku#28";
 String token = "1786588964:AAGjCx0kgjAZPe3sb1UDTM41QVjMxWhY6cM";
...
TBMessage msg;
    ...
    if (msg.text.equalsIgnoreCase("/start")) {                                         
          myBot.sendMessage(msg.sender.id, "Selamat datang di layanan lampu otomatis");
          myBot.sendMessage(msg.sender.id, "Halo...\nSelamat Datang Di Bot Lampu.\n\nGunakan tombol dibawah untuk mengontrol lampu 👇", Tbl);
          Serial.println("\nUser memulai Bot \n");
